...
We have earlier talked about methods to detect auto-correlation -- visualisation and Moran's I. Both methods can tell us that there is spatial autocorrelation. However, both methods do not provide any information on why there is autocorrelation. Possible reasons:
